...
const encriptar = () => {
    ...
    const resultadoEncriptar = text.replace(/e/g, 'esp').replace(/i/g, 'imes').replace(/a/g, 'alf')
        .replace(/o/g, 'osis').replace(/u/g, 'uni');
...
const descriptografar = () => {
    ...
    const resultadoDescriptografar = text.replace(/esp/g, 'e').replace(/imes/g, 'i').replace(/alf/g, 'a')
        .replace(/osis/g, 'o').replace(/uni/g, 'u');
